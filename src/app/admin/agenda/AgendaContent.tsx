      ...
      <div className="flex items-center gap-2 ml-4 shrink-0">
        {app.status === "confirmed" && (
          <>
            <button
              onClick={onConfirm}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-500/10 text-emerald-400 rounded-lg text-xs font-medium hover:bg-emerald-500/20 transition-all"
            >
